...
public class MPGImport
{
    ...
    public enum mpg123_param_flags
    {
        ...
        MPG123_IGNORE_STREAMLENGTH =
            0x1000 /**< 1000000000000 Ignore any stream length information contained in the stream, which can be contained in a 'TLEN' frame of an ID3v2 tag or a Xing tag */
    };
    ...
    public enum mpg123_text_encoding
    {
        ...
        /**< Some UTF-16 encoding. The last of a set of leading BOMs (byte order mark) rules.
        ...
        /**< Another alias for UTF16 from ID3v2. Note, that, because of the mess that is reality,
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_decode(IntPtr mh, IntPtr inmemory, int inmemsize, IntPtr outmemory, int outmemsize,
        IntPtr done);
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_position(IntPtr mh, int frame_offset, int buffered_bytes, IntPtr current_frame,
        IntPtr frames_left, IntPtr current_seconds, IntPtr seconds_left);
    ...
    public static extern int
        mpg123_fmt(IntPtr mh, Int32 rate, int channels, int encodings); /* 0 is good, -1 is error */
